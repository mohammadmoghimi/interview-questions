...
// subsequence of three integers nums[i], nums[j] 
// and nums[k] such that i < j < k and nums[i] 
// < nums[k] < nums[j].
...
// Input: nums = [3,1,4,2]
// Output: true
// Explanation: There is a 132 pattern in 
// the sequence: [1, 4, 2].
// Example 3:

// Input: nums = [-1,3,2,0]
// Output: true
// Explanation: There are three 132 patterns 
