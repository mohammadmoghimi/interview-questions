...
// Find out the state of the asteroids after 
// all collisions. If two asteroids meet, the 
// smaller one will explode. If both are the 
// same size, both will explode. Two asteroids 
...
// Output: [5,10]
// Explanation: The 10 and -5 collide resulting in 
// 10. The 5 and 10 never collide.
// Example 2:
...
var asteroidCollision = function(asteroids) {
    ...
    for (const asteroid of asteroids) {
        ...
        if (!explode) stack.push(asteroid);
    }
    return stack;
};