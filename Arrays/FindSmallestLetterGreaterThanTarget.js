...
//  non-decreasing order, and a character target. There are at
...
var nextGreatestLetter = function(letters, target) {
    let smallestCharacter = null ;
    for(let char of letters ) {
        if(char > target) {
            smallestCharacter = char ;
            break ;
        }
    }
    return smallestCharacter !== null ? smallestCharacter : letters[0];
};