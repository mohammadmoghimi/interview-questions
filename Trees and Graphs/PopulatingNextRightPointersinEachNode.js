...
//   Node *next;
// }
// Populate each next pointer to point to 
// its next right node. If there is no next 
...
// Explanation: Given the above perfect binary 
// tree (Figure A), your function should populate 
